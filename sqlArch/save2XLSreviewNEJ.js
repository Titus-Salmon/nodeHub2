...
module.exports = {
  ...
  save2XLSreviewNEJ: router.post('/save2XLSreviewNEJ', (req, res, next) => {
    ...
    for (let a = 0; a < srcRsXLS_nonPag.length; a++) {
      let invPK = srcRsXLS_nonPag[a][0]
      let invCPK = srcRsXLS_nonPag[a][1]
      let upc = srcRsXLS_nonPag[a][2]
      let edlpUPC = srcRsXLS_nonPag[a][3]
      let edlpVar = srcRsXLS_nonPag[a][4]
      let cpltCost = srcRsXLS_nonPag[a][5]
      let cpltSKU = srcRsXLS_nonPag[a][6]
      let ediSKU = srcRsXLS_nonPag[a][7]
      let imwSKU = srcRsXLS_nonPag[a][8]
      let skuMismatch = srcRsXLS_nonPag[a][9]
      let oupName = srcRsXLS_nonPag[a][10]
      let stoNumber = srcRsXLS_nonPag[a][11]
      let stoName = srcRsXLS_nonPag[a][12]
      let pf1 = srcRsXLS_nonPag[a][13]
      let pf2 = srcRsXLS_nonPag[a][14]
      let pf6 = srcRsXLS_nonPag[a][15]
      let ovr = srcRsXLS_nonPag[a][16]
      let name = srcRsXLS_nonPag[a][17]
      let ediCost = srcRsXLS_nonPag[a][18]
      let ediCostMod = srcRsXLS_nonPag[a][19]
      let ediPrice = srcRsXLS_nonPag[a][20]
      let sibBasePrice = srcRsXLS_nonPag[a][21]
      let dptName = srcRsXLS_nonPag[a][22]
      let dptNumber = srcRsXLS_nonPag[a][23]
      let defaultMarg = srcRsXLS_nonPag[a][24]
      let sibIdealMargin = srcRsXLS_nonPag[a][25]
      let sale_flag = srcRsXLS_nonPag[a][26]
      let discountToApply = srcRsXLS_nonPag[a][27]
      let lastCost = srcRsXLS_nonPag[a][28]
      let numPkgs = srcRsXLS_nonPag[a][29]
      let csPkgMltpl = srcRsXLS_nonPag[a][30]
      let reqdRetail = srcRsXLS_nonPag[a][31]
      let charm = srcRsXLS_nonPag[a][32]
      let appldMrgn = srcRsXLS_nonPag[a][33]
