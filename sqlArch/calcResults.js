...
const showSearchResults = require('../funcLib_t0d/showSearchResults')
...
// common.func1();
//i.e. (in our case) skuMismatchFlagOptionHandler.skuMismatchFlagOptionHandler()
...
module.exports = {
  ...
  calcResults: router.post('/calcResults', (req, res, next) => {
    ...
    function queryNhcrtEdiJoinTable() {
      ...
      connection.query(`SELECT * FROM ${formInput0} GROUP BY ${showSearchResults.showSearchResults().genericHeaderObj.upcHeader}, ${showSearchResults.showSearchResults().genericHeaderObj.invLastcostHeader} ORDER BY ${showSearchResults.showSearchResults().genericHeaderObj.upcHeader};
