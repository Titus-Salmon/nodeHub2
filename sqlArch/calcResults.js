...
module.exports = {
  ...
  calcResults: router.post('/calcResults', (req, res, next) => {
    ...
    console.log(`formInputsObjCacheChecker from POST==> ${formInputsObjCacheChecker}`)
    ...
    console.log(`genericHeaderObjCacheChecker from POST==> ${genericHeaderObjCacheChecker}`)
  ...
  calcResultsGET: router.get('/calcResults', (req, res, next) => {
    ...
    console.log(`formInputsObjCacheChecker from GET==> ${formInputsObjCacheChecker}`)
    console.log(`genericHeaderObjCacheChecker from GET==> ${genericHeaderObjCacheChecker}`)
