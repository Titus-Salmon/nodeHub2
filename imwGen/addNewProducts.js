...
module.exports = {
  ...
  addNewProducts: router.post('/addNewProducts', (req, res, next) => {
    ...
    // itmlstaccsntzr.itmLstAccSntzr(postBody)
    ...
    itmlstaccsntzr.sntzdItmLstObjGen(postBody)
    ...
    itmlstaccsntzr.objctfyImwPrdctArr()
    ...
    res.render('vw-imwGenerator', {
      ...
      imwProductValObj_t0d: itmlstaccsntzr.itemListObjs.imwProductValObj,
      imwProductArr_t0d: itmlstaccsntzr.itemListObjs.imwProductArr,
      objectifiedImwProdArr_t0d: itmlstaccsntzr.itemListObjs.objectifiedImwProdArr
    })
